    ...
    return Scaffold(
      ...
      body: Center(
        child: SfCalendar(
          ...
          dataSource: _ScheduleDataSource(globals.appointments),
        ),
      ),
...
_ScheduleDataSource _getCalendarDataSource() {

  DateTime exceptionDate = DateTime(2019, 12, 20);
  globals.appointments.add(Appointment(
  ...
  return _ScheduleDataSource(globals.appointments);
}
